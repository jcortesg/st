  ...
  class << self
    ...
    def apply_filters(campaign)
      ...
      campaign.locations.each do |location|
        case location
          when 'Argentina'
            locations_conditions << "(audiences.country_argentina > 0)"
          when 'Colombia'
            locations_conditions << "(audiences.country_colombia > 0)"
          when 'Chile'
        ...
        case APP_CONFIG['app_country']
          ...
          when 'CO'
            campaign.tweet_price.each do |tp|
              case tp
                when '0-150000'
                  conditions << "(influencers.campaign_fee >= 0 and influencers.campaign_fee <= 150000)"
                when '150000-500000'
                  conditions << "(influencers.campaign_fee >= 150000 and influencers.campaign_fee <= 500000)"
                when '500000-1000000'
                  conditions << "(influencers.campaign_fee >= 500000 and influencers.campaign_fee <= 1000000)"
                when '1000000-1500000'
                  conditions << "(influencers.campaign_fee >= 1000000 and influencers.campaign_fee <= 1500000)"
                when '1500000-2500000'
                  conditions << "(influencers.campaign_fee >= 1500000 and influencers.campaign_fee <= 2500000)"
                when '2500000-3500000'
                  conditions << "(influencers.campaign_fee >= 2500000 and influencers.campaign_fee <= 3500000)"
                when '3500000-5000000'
                  conditions << "(influencers.campaign_fee >= 3500000 and influencers.campaign_fee <= 5000000)"
                when '5000000-10000000'
                  conditions << "(influencers.campaign_fee >= 5000000 and influencers.campaign_fee <= 10000000)"
