...
describe "audiences/new.html.haml" do
  before(:each) do
    assign(:audience, stub_model(Audience,
      :influencer_id => 1,
      :followers => 1,
  ...
  it "renders new audience form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => audiences_path, :method => "post" do
